...
VIDEO_PRESET_OPTS='-vcodec libx264 -vprofile baseline -preset veryfast -level 31 -keyint_min 24 -g 24 -r 24 -an'
AUDIO_PRESET_OPTS='-acodec aac -strict -2 -ar 48000 -ac 2'
...
$DASH_VLC -I dummy -L $DASH_SOURCE_INPUT_FILE \
  ...
  ffmpeg -re -i - -analyzeduration 2147483647 -probesize 2147483647 -threads 0 -y \
